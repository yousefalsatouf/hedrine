				...
				<tr class="text-center">
					...
					<td style="width: 10rem">
						<div class="btn-group float-right">&nbsp; &nbsp; &nbsp;
							...
							<a class="btn btn-outline-success" href="{{ route('user.edit',$user->id) }}" role="button"><i class="fas fa-edit"></i> </a> &nbsp; &nbsp;
							
							<a class="btn btn-outline-danger" href="{{ route('user.destroy.alert',$user->id) }}" role="button"><i class="far fa-trash-alt"></i> </a> 
