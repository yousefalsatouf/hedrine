        ...
        <!-- Notifications Dropdown Menu -->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="badge badge-warning navbar-badge" style="font-size: 15.5px" >{{ $noValidHerbsCounter->count()  }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <span class="dropdown-item dropdown-header"> {{ $notifications }} Notifications</span>
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('admin.herbs') }}" class="dropdown-item">
                        <i class="fas fa-seedling mr-2" style="color: seagreen"></i> {{$noValidHerbsCounter->count()}}
