...
Drug::create( [
    ...
    Drug::create( [
    'id'=>423,
    'name'=>'MESILATE DE DIHYDROERGOCRYPTINE',
    'drug_families_id'=>7,
    'route_id'=>2,
    'user_id'=>2,
    'validated'=>'1', 'atc_level_4s_id'=>1
